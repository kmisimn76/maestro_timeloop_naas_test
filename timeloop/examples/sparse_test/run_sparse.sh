...
time ../../build/timeloop-model ./arch/sparse_npu.arch.yaml ./comp/metadata.yaml ./map/sparse_npu.map.yaml ./sparse_opt/sparse.yaml ./prob/conv1d_sparse.prob.yaml -o output_sparse/
