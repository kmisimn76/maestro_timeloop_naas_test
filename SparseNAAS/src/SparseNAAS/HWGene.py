...
class _HWGene(object):
    def get_sample_gene(self):
        return [3000, 100, 8, 50, 2, 0.5, 0.5, 0.5, 6,5,4,3,2,1, 1, 4, 10000, 10000, 10000, 0.5, 0.5, 0.5]
    def generate_random_gene(self):
        L2Buf = random.random()
        L1Buf = random.random()
        L2Buf_weight = random.randint(100, 4*128000)
        L2Buf_input = random.randint(100, 4*128000)
        L2Buf_output = random.randint(100, 4*128000)
