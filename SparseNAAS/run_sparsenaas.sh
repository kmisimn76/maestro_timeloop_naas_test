...
then
    ...
    $RUNPYTHON main.py --outdir outdir/res --model resnet50_sparse --fitness latency --cstr area --mul 0.5  --epochs 2100 --num_pop 100 --num_parents 25 --df shi --alg genetic #sparse
