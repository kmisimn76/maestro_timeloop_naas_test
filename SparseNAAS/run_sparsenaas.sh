...
if [ $1 = "VGG" ]
then
    $RUNPYTHON main.py --outdir outdir/vgg_new_opt --model vgg16_sparse_group --fitness latency --cstr area --mul 0.5 --epochs 21000 --num_pop 100 --num_parents 25 --df shi --alg genetic
elif [ $1 = "RES" ]
then
    $RUNPYTHON main.py --outdir outdir/resnet_new_opt --model resnet50_sparse --fitness latency --cstr area --mul 0.5  --epochs 21000 --num_pop 100 --num_parents 25 --df shi --alg genetic #sparse
